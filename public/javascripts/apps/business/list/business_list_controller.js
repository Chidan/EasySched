        ...
        listBusiness: function (criterion) {
            ...
            $.when(fetchingBusiness).done(function (business) {
                if (business !== undefined) {
                    ...
                    businessListView.on('itemview:show:serviceTypesProviders', function (childView, businessModel) {
                        SuperAppManager.trigger("show:serviceTypesProviders", businessModel);
                    });
